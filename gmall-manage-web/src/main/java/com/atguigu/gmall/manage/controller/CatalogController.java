...
public class CatalogController {
    ...
    public List<BaseCatalog2> getCatalog2(@RequestParam Map<String ,String> map){
        ...
        List<BaseCatalog2> baseCatalog2s = catalogService.getCatalog2ByCataLog1Id(catalog1Id);
    ...
    public List<BaseCatalog3> getCatalog3(@RequestParam Map<String ,String> map) {
        ...
        List<BaseCatalog3> baseCatalog3s = catalogService.getCatalog3ByCataLog2Id(catalog2Id);
